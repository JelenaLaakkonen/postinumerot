...
def ryhmitelty():
    ...
    return postinumerot3.ryhmittele_toimipaikoittain(kaikki)
...
def test_etsi_postinumero_toimii_kirjainkoosta_riippumatta(ryhmitelty):
    numerot = postinumerot3.etsi_postinumerot('Kivijärvi', ryhmitelty)

    assert numerot == ["43800"]


def test_etsi_smart_post_eri_kirjoitsasuilla(ryhmitelty):
    SMARTPOST = postinumerot3.etsi_postinumerot('SMARTPOST', ryhmitelty)
    smartpost = postinumerot3.etsi_postinumerot('smartpost', ryhmitelty)
    smart_post = postinumerot3.etsi_postinumerot('SMART POST', ryhmitelty)
